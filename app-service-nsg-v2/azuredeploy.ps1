...
$rootPath = 'C:\Users\nataliak\Source\Repos\ase-ilb\app-service-nsg-v2' # Replace with $PSScriptRoot if you want to run it as a script; EXAMPLE: $rootPath = 'C:\Users\makolo\Documents\GitHub\azure-vmss-templates\vm-simple-rhel'
