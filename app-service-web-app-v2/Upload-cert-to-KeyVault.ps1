...
$pfxFilePath = "C:\Users\nataliak\OneDrive - Microsoft\Customers\Manulife\TRS\ASEv2-ARM Templates\DigiCert_cert\startazureminilab.pfx" # Change this path 
$pwd = "R37fallacy" # Change this password 
$KeyVaultSecretName="azureminilab-web-cert"     #change to set the name of the secret
